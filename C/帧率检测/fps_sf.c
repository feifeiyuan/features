...
static long int cal_fps(long int start_frame, float *ret_fps, int accumulate_time)
{
...
int main(int argc, char *argv[])
{
	...
	start_frame = cal_fps(start_frame, &fps, accumulate_time);
	//printf("fps: %.2f\n", fps);
